...
<head>
    ...
    <style>
        ...
        .action-btn { width: 40px; height: 40px; border-radius: 10px; display: flex; align-items: center; justify-content: center; text-decoration: none; transition: 0.2s; font-size: 18px; }
            ...
            <div class="req-list">
                ...
                <div class="req-item" style="border-left: 4px solid var(--accent-orange);">
                    ...
                    <div class="col-md-2 d-flex justify-content-end">
                        <a href="verify_payment.php?id=<?php echo $pay['pay_id']; ?>&action=confirm" class="action-btn btn-accept" title="Confirm Payment" onclick="return confirm('Confirm this payment?');"><i class="bi bi-check-lg"></i></a>
                        <a href="verify_payment.php?id=<?php echo $pay['pay_id']; ?>&action=reject" class="action-btn btn-reject" title="Reject Payment" onclick="return confirm('Reject this payment?');"><i class="bi bi-x-lg"></i></a>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <?php if ($total_pending_apps > 0): ?>
            <div class="req-list">
                ...
                <div class="req-item">
                    ...
                    <div class="col-md-2 d-flex justify-content-end">
                        <a href="handle_application.php?id=<?php echo $req['app_id']; ?>&action=approve" class="action-btn btn-accept" title="Approve"><i class="bi bi-check-lg"></i></a>
                        <a href="handle_application.php?id=<?php echo $req['app_id']; ?>&action=reject" class="action-btn btn-reject" title="Reject" onclick="return confirm('Reject this application?')"><i class="bi bi-x-lg"></i></a>
                    </div>
                </div>
                <?php endwhile; ?>
            </div>
