...
<head>
    ...
    <style>
        ...
        .prop-card { background: var(--bg-card); border-radius: 20px; overflow: hidden; border: 1px solid rgba(255,255,255,0.05); transition: 0.3s; height: 100%; display: flex; flex-direction: column; }
    ...
    <div class="container">
        ...
        <div class="ms-auto d-flex align-items-center">
            <?php if(isset($_SESSION['user'])): ?>
                <?php 
                    // SAFE CHECK: Use ?? to provide a default empty string if 'role' is missing
                    $role = $_SESSION['role'] ?? ''; 
                    
                    $dash = "dashboard_tenant.php"; // Default
